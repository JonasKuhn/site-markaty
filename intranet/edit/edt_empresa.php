        ...
        <div class="card-body">
            <form class="form-horizontal" method="POST" action="?url=edtbd_empresa.php&ldl=<?= $var; ?>&ldk=<?= $logomarca; ?>" enctype="multipart/form-data">
                    ...
                    <div class="container col-sm-6">
                        <div class="form-group">
                            <div class="col-sm-12 row">
                                <div class="col-sm-3">
                                    <img class="img-fluid" src="./imagens/logomarca/<?= $logomarca; ?>" >
                                </div>
                                <div class="col-sm-9">
                                    <label class="col-sm-12">Logo Marca: <?= $logomarca; ?></label>
                                    <input class="col-sm-12" type="file" class="form-control" name="logomarca" placeholder="Selecione a Logo Marca da Empresa...">
                                </div>
                            </div>
                        </div>
                        <hr class="b-s-dashed">
                ...
                <div class="container-fluid center-block" style="display: flex;
                     ...
                     align-items: center;">
                    <input class="col-sm-5 btn btn-dark btn-block" type="submit" onclick="return editar('<?php $nome_fantasia; ?>');" value="EDITAR" name="editar">
                </div>
            </form>
        </div>
    </div>
